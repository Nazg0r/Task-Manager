...
{
	public class TaskFactory : WebApplicationFactory<Program>, IAsyncLifetime
	{
		private readonly PostgreSqlContainer _container = new PostgreSqlBuilder()
			.WithUsername("test")
			.WithPassword("password")
			.WithDatabase("task_test_db")
			.Build();
		...
		public async Task InitializeAsync()
		{
			...
			await IntegrationTestHelper.AddRecordToDb(TaskSeeder.sqlQuery, _container.GetConnectionString());
		}
